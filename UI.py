...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.expenses = customtkinter.CTkImage(
            light_image=Image.open(os.path.join(image_path, "expenses_dark.png")),
            dark_image=Image.open(os.path.join(image_path, "expenses_light.png")), size=(20, 20))
        ...
        self.all_transactions = customtkinter.CTkImage(
            ...
            dark_image=Image.open(os.path.join(image_path, "all transaction dark.png")),
            size=(20, 20))
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text=" Budget Bytes",
                                                             image=self.dollar_sign,
                                                             compound="left",
